  ...
  <section class="preview-panel">
    <div class="preview-panel__header">
      <div class="preview-panel__title-wrap">
        <h4 class="preview-panel__title">最近失败日志</h4>
    ...
    <div v-else-if="!items.length" class="preview-panel__state">近7天无失败日志</div>
...
const totalText = computed(() => `${Number(props.total || 0).toLocaleString('zh-CN')} 条`)
</script>
