  ...
  <div class="ops-page-layout">
    ...
    <div class="ops-table-wrapper">
      <el-table v-loading="loading" :data="tableData" max-height="calc(100vh - 250px)">
          ...
          <template #default="{ row }">
            <div class="service-cell">
              <div
                ...
                :key="`${row.id || row.name || 'service'}-${index}`"
                class="service-item"
                :title="service"
              >
                {{ service }}
              ...
              >
                ...
                <div class="services-popover">
                  <div
                    ...
                    :key="`${row.id || row.name || 'popover-service'}-${index}`"
                    class="service-item"
                  >
                    {{ service }}
                  </div>
        ...
        <!-- <el-table-column prop="architecture" label="描述" width="120" /> -->
      </el-table>
    </div>
