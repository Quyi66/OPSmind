export const WORKBENCH_LAUNCHER_DEFS = [
  {
    ...
    primaryLabel: '立即新建',
    secondaryLabel: '运维工具列表',
    secondaryTo: '/jao/jobs'
  },
  {
    key: 'scriptJob',
    label: '脚本运维工具',
    description: '把脚本库里的执行材料快速编排成可复用运维工具。',
    eyebrow: '运维工具创建',
    tone: 'success',
  ...
  },
  {
    key: 'commandJob',
    label: '命令运维工具',
    description: '将沉淀好的命令组合成标准运维工具，方便复用和审批。',
    eyebrow: '运维工具创建',
    tone: 'warning',
  ...
  },
  {
    key: 'cronJob',
    label: '定时任务',
    description: '把已有运维工具纳入例行调度，统一控制启停和执行窗口。',
    eyebrow: '调度编排',
    tone: 'info',
    icon: 'fas fa-clock',
    permission: ['jobs'],
  ...
  },
  {
    key: 'scriptFile',
    label: '脚本文件',
    description: '直接补充新的脚本材料，随后可立即转成脚本运维工具。',
    eyebrow: '执行材料',
    tone: 'success',
    icon: 'fas fa-scroll',
    permission: ['scripts'],
  ...
  },
  {
    key: 'uploadFile',
    label: '执行文件',
    description: '上传压缩包、模板和其它执行材料，供运维工具和流程直接引用。',
    eyebrow: '执行材料',
    tone: 'default',
    icon: 'fas fa-upload',
    permission: ['scripts'],
...
export const WORKBENCH_FLOW_DEFS = [
  {
    key: 'commandChain',
    title: '命令下发链路',
    description: '从沉淀命令到生成命令运维工具，再进入执行复盘。',
    tone: 'warning',
    icon: 'fas fa-terminal',
    permission: ['jobs', 'commands'],
    steps: ['沉淀命令', '生成运维工具', '执行复盘'],
    primaryAction: 'create-command-job',
    primaryLabel: '新建命令运维工具',
    secondaryTo: '/cmd/list',
    secondaryLabel: '进入命令执行'
  },
  {
    key: 'scriptChain',
    title: '脚本执行链路',
    description: '从脚本材料到脚本运维工具，再衔接定时任务和运行记录。',
    tone: 'success',
    icon: 'fas fa-file-code',
    permission: ['jobs', 'scripts'],
    steps: ['准备脚本', '生成运维工具', '纳入调度'],
    primaryAction: 'create-script-job',
    primaryLabel: '新建脚本运维工具',
    secondaryTo: '/gfs/scriptLibrary',
