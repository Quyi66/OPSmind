/**
 *
 * @author Leo Liao (leoliaolei@gmail.com), created on 12/6/2017
 */
(function () {
    'use strict';

    angular.module('oplus.udp').directive('udpColorPicker', udpColorPickerDirective);

    udpColorPickerDirective.$inject = ['themeService'];

    /**
     * @ngdoc directive
     * @name udpColorPicker
     * @description
     * Color picker based on spectrum
     * ```
     * <udp-color-picker ng-model="">
     * ```
     * @param {themeService} themService
     */
    function udpColorPickerDirective(themService) {
        var palette = themService.getColorPickerPalette();
        return {
            restrict: 'E',
            require: 'ngModel',
            scope: {
            ...
            replace: true,
            templateUrl: 'app/modules/udp/helper/color-picker.html',
            link: function ($scope, $element, attrs, $ngModel) {
                ...
                var baseOpts = {
                    ...
                    showAlpha: true,
                    localStorageKey: "oplus.common.colorpicker",
                    maxPaletteSize: 10,
                    preferredFormat: "rgb",
                    palette: palette
                };
                ...
                }, baseOpts, $scope.options, localOpts);
