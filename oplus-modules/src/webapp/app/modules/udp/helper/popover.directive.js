/**
 *
 * @author Leo Liao (leoliaolei@gmail.com), created on 12/15/2017
 */
(function () {
    'use strict';
    angular.module('oplus.udp').directive('popoverHoverable', ['$timeout', '$document', function ($timeout, $document) {
        return {
            restrict: 'A',
            scope: {
                popoverHoverable: '=',
