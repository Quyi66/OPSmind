  ...
  this.container = domify(
    '<div class="set-animation-speed hidden">' +
      ...
      '<div class="animation-speed-buttons">' +
        ...
        '<div title="Fast" style="width: 40px;" id="animation-speed-3" class="animation-speed-button"><i class="fa fa-angle-right" aria-hidden="true"></i><i class="fa fa-angle-right" aria-hidden="true"></i><i class="fa fa-angle-right" aria-hidden="true"></i></div>' +
      '</div>' +
    '</div>'
  );
