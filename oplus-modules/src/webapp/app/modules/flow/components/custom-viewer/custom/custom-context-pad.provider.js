...
inherits(CustomViewerContextPadProvider, ContextPadProvider)

CustomViewerContextPadProvider.$inject = [
  'injector',
  'connect',
  'translate',
  'elementFactory'
...
export default function CustomViewerContextPadProvider(injector, connect, translate) {
  ...
  this.getContextPadEntries = function (element) {
    ...
    function appendAction(type, className, title, options) {
      ...
      return {
        group: 'model',
        className: className,
        title: translate(title || 'Create {type}', {
          type: shortType
        } || 'Append {type}', {
          type: shortType
        }),
