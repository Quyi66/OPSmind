...
function isCustom(element) {
  return element && new RegExp(`^${eleConst.prefixEx()}`).test(element.type)
}
...
CustomRules.prototype.init = function () {
  ...
  this.addRule('elements.move', HIGH_PRIORITY, function (context) {
    ...
    }, undefined) // reject, if we have at least one    // custom element that cannot be moved
    return allowed
  })
