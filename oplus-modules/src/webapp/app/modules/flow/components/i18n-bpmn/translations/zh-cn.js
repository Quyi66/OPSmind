...
export default {
  ...
  'Create Error Boundary Event': '创建异常边界事件',
  'Create EndEvent': '创建结束节点',
  'Create Task': '创建任务',
  'Create Group': '创建组',
  'Create DataObjectReference': '创建数据对象引用',
  'Create DataStoreReference': '创建数据存储引用',
  'Singleton Process Description': '只允许有一个运行中的流程实例',
  'Java Delegate Description': '可以执行某Java类中的某方法 [类全限定名]#[方法名] e.g. com.SuchAClass#SuchAMethod',
  'Force Job': '强制检查',
  'Force Job Description': '当前作业所有主机运行成功才算成功',
  ...
  'Create Job Task': '创建作业任务',
  'Create Manual Task': '创建手动任务',
  'Create Reboot Task': '创建重启任务',
  'Create Java Task': '创建 Java 任务',
  'Create Approve Task': '创建审批任务',
  'Create SubProcess Task': '创建子流程',

  'Lint-No Disconnected': '元素没有连线或者出线!',
}
