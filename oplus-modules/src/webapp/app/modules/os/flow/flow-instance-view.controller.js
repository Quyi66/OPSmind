...
(function () {
    ...
    angular.module('oplus.os').controller('flowInstanceViewCtrl', FlowInstanceViewCtrl);

    FlowInstanceViewCtrl.$inject = ['$q', '$scope', '$rootScope', '$state', '$timeout', '$uibModal', 'messageService', 'flowService', '$stateParams', '$compile', 'gfileService', '$translate'];
     ...
     * @constructor
     */
    function FlowInstanceViewCtrl($q, $scope, $rootScope, $state, $timeout, $uibModal, messageService, flowService, $stateParams, $compile, gfileService, $translate) {
        var that = this;
        ...
        function onInit() {
            ...
            flowService.getFlowInstanceViewById(id).then(function (result) {
            ...
            that.flowInstance.steps.forEach(function (step, index) {
                var column = {
                    ...
                    render: function (data, type, row, meta) {
                        ...
                        var click;
                        if (run_ids) {
                            click = ' udp-widget-interaction=\'{"actions":["page"],"page":{"params":{"run_ids":"' + run_ids + '"},"pageId":"/jao/assets/udp/runlogs","target":"_dialog","size":"lg"}}\'';
                        }
                        return  "<div style='width: 100%'" + click + " class=\"text-center opx-autocolor {{::$ctrl.statusMap['" + data + "'].class}}\">" +
        ...
        function clickHost(stepIndex, hostId) {
            ...
            flowService.getHostStatusByStepIdAndHostKey(that.flowInstance.steps[stepIndex].id, hostId).then(function (result) {
