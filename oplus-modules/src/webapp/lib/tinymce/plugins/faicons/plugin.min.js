...
(function () {
    ...
    var faicons = function () {
        ...
        tinymce.PluginManager.add('faicons', function (editor, url) {
            ...
            var fai_selectedIconSize = editor.getParam('faicons_default_size', 'fa-1x');
            var fai_selectedIconID = -1;
            var fai_selectedIconColor = '#' + editor.getParam('faicons_default_color', '858796');
            var fai_dialog = false;
            var fai_html = '';
            var fai_htmlSettings = '<i class="fasizing fa-camera fa-xs" data-faicon-size="fa-xs" style="font-family: \'Font Awesome 5 Pro\'; font-weight: 900; font-size: .75em; cursor: pointer; margin: 2px;"></i>';
            fai_htmlSettings = fai_htmlSettings + '<i class="fasizing fa-camera fa-sm" data-faicon-size="fa-sm" style="font-family: \'Font Awesome 5 Pro\'; font-weight: 900; font-size: .875em; cursor: pointer; margin: 2px;"></i>';
            fai_htmlSettings = fai_htmlSettings + '<i class="fasizing fa-camera fa-lg" data-faicon-size="fa-lg" style="font-family: \'Font Awesome 5 Pro\'; font-weight: 900; font-size: 1.33333em; cursor: pointer; margin: 2px;"></i>';
            fai_htmlSettings = fai_htmlSettings + '<i class="fasizing fa-camera fa-2x" data-faicon-size="fa-2x" style="font-family: \'Font Awesome 5 Pro\'; font-weight: 900; font-size: 2em; cursor: pointer; margin: 2px;"></i>';
            fai_htmlSettings = fai_htmlSettings + '<i class="fasizing fa-camera fa-3x" data-faicon-size="fa-3x" style="font-family: \'Font Awesome 5 Pro\'; font-weight: 900; font-size: 3em; cursor: pointer; margin: 2px;"></i>';
            fai_htmlSettings = fai_htmlSettings + '<i class="fasizing fa-camera fa-5x" data-faicon-size="fa-5x" style="font-family: \'Font Awesome 5 Pro\'; font-weight: 900; font-size: 5em; cursor: pointer; margin: 2px;"></i>';
            fai_htmlSettings = fai_htmlSettings + '<i class="fasizing fa-camera fa-7x" data-faicon-size="fa-7x" style="font-family: \'Font Awesome 5 Pro\'; font-weight: 900; font-size: 7em; cursor: pointer; margin: 2px;"></i>';
            fai_htmlSettings = fai_htmlSettings + '<i class="fasizing fa-camera fa-10x" data-faicon-size="fa-10x" style="font-family: \'Font Awesome 5 Pro\'; font-weight: 900; font-size: 10em; cursor: pointer; margin: 2px;"></i>';
            var fai_dialogApi;
                        ...
                        if (details.newTabName == 'settings') {
                            ...
                            if (fai_selectedIconID != -1) {
                                ...
                                if (fai_selectedIconType == 'fas') {
                                    ...
                                    for (var i = 0; i < els.length; i++) {
                                        var e = els[i];
                                        e.style.fontFamily = "\'Font Awesome 5 Pro\'";
            ...
            function fai_generateHtml(data) {
                ...
                for (var i = 0; i < els.length; i++) {
                    ...
                    if (item.type == 'fas') {
                        fai_html = fai_html + '<i class="fa-' + item.name + '" style="font-family: \'Font Awesome 5 Pro\'; font-weight: 900; font-size: 3em;"></i>';
                    }
                    else if (item.type == 'far') {
                        fai_html = fai_html + '<i class="fa-' + item.name + '" style="font-family: \'Font Awesome 5 Pro\'; font-weight: 400; font-size: 3em;"></i>';
                    }
